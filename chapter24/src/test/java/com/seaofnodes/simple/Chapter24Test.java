...
public class Chapter24Test {
    ...
    public void codegen() throws IOException {
        ...
        code.parse()
                .opto()
                .typeCheck()
                .loopTree() // <--- 必須加上這一行！它會執行 _start.buildLoopTree(_start, _stop)
                .instSelect("x86_64_v2", "SystemV")
                .GCM()
                .localSched()
                .regAlloc()
                .encode();
        if (c != null)
            for (var n : code._start._outputs)
                if (n instanceof FunNode f && f._name.equals("main"))
                    f._name = "simple_main";
    ...
    public void testAnd() throws IOException {
        ...
        TestC.runSF("and1", "sys.io.p(\"1\");return 0;", null, "1", 0);
